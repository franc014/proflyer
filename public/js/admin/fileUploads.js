$(window).bind('load', function () {
    $(document).ready(function () {
        ...
        var spinner = ['<div id="spinner" style="width: 70px;height: 70px" class="sk-spinner sk-spinner-double-bounce pull-left">',
        ...
        $('#fileupload').fileupload({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                if (jqXHR.status == 500) {
                    setStatusBar(0);
                    setAlert('danger',"Hubo un error en la carga del archivo. Verifica que sea tipo png o jpeg");
                    unsetAlert(4000);
